    ...
    <div style={{ minHeight: '100vh', display: 'flex', background: 'var(--navy)' }}>
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '2rem' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          <div style={{ fontSize: '8.5px', fontWeight: 700, letterSpacing: '.15em', textTransform: 'uppercase', color: 'var(--red)', marginBottom: '.4rem' }}>
            Acceso restringido
          </div>
          <div style={{ fontSize: '13px', fontWeight: 800, color: '#fff', lineHeight: 1.4 }}>
            Scania —<br/>Malla de Capacitación<br/>de Almacenes
          </div>
          <div style={{ fontSize: '8.5px', color: 'rgba(255,255,255,.38)', textTransform: 'uppercase', letterSpacing: '.12em', marginTop: '4px' }}>
      ...
      <div style={{ width: '265px', background: '#fff', padding: '1.7rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        {error && (
          <div style={{ fontSize: '9.5px', color: 'var(--red)', fontWeight: 600, marginBottom: '5px' }}>{error}</div>
        )}
